...
RUN mkdir -p /usr/src/utu_geonode
...
COPY src /usr/src/utu_geonode/
WORKDIR /usr/src/utu_geonode
...
RUN chmod +x /usr/src/utu_geonode/tasks.py \
    && chmod +x /usr/src/utu_geonode/entrypoint.sh
...
# ENTRYPOINT /usr/src/utu_geonode/entrypoint.sh
